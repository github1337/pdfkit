...
(function() {
  ...
  StandardFont = (function(superClass) {
    ...
    STANDARD_FONTS = {
      ...
      "Roboto-Light": function() {
        return fs.readFileSync(__dirname + "/../font/data/Roboto-Light.afm", 'utf8');
      },
      "Roboto-Medium": function() {
        return fs.readFileSync(__dirname + "/../font/data/Roboto-Medium.afm", 'utf8');
      },
      "Roboto-Regular": function() {
        return fs.readFileSync(__dirname + "/../font/data/Roboto-Regular.afm", 'utf8');
      }
    };
